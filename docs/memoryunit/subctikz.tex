...
\newcommand\shiftRegister[3] {
    \subctkshiftRegister {#1} {#2}

    (#1-msff00.center) node[] {#3}
    (#1-msff01.center) node[] {#3}
    (#1-msff02.center) node[] {#3}
    (#1-msff03.center) node[] {#3}
    (#1-msff04.center) node[] {#3}
    (#1-msff05.center) node[] {#3}
    (#1-msff06.center) node[] {#3}
    (#1-msff07.center) node[] {#3}
    (#1-msff08.center) node[] {#3}
    (#1-msff09.center) node[] {#3}
    (#1-msff10.center) node[] {#3}
    (#1-msff11.center) node[] {#3}
    (#1-msff12.center) node[] {#3}
    (#1-msff13.center) node[] {#3}
    (#1-msff14.center) node[] {#3}
    (#1-msff15.center) node[] {#3}
}
