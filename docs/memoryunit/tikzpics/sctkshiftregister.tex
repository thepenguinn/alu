\ctikzsubcircuitdef{sctkshiftregister} {
    sin, reclk, feclk, rst,
    ...
    \sctkmsflipflop {#1-msff15} {d} {}
    %%
    (#1-msff15-qbar)
    ++(1.5,-1)
    %%
    \sctkmsflipflop {#1-msff14} {d} {}
    (#1-msff14-qbar) ++($(#1-msff14-d)-(#1-msff15-qbar)$)
    \sctkmsflipflop {#1-msff13} {d} {}
    (#1-msff13-qbar) ++($(#1-msff14-d)-(#1-msff15-qbar)$)
    \sctkmsflipflop {#1-msff12} {d} {}
    %%
    %%
    %%
    (#1-msff15-qbar)
...
\ctikzsubcircuitactivate{sctkshiftregister}

\newcommand\sctklabelshiftregister [2] {
