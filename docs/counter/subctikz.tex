...
\ctikzsubcircuitdef{subctkcounterFour} {
    ...
    \constcornerup {(#1-mux00out|-#1-msffreclkheight) ++(1,0)}
    \constcornerright {(#1-msff01-reclk)}
    -- (#1-msff01-reclk)
    %%
    (#1-mux01-out)
    \constcornerright {(#1-mux01out) ++(0,1)}
    \constcornerup {(#1-mux01out|-#1-msffreclkheight) ++(1,0)}
    \constcornerright {(#1-msff02-reclk)}
    -- (#1-msff02-reclk)
    %%
    (#1-mux02-out)
    \constcornerright {(#1-mux02out) ++(0,1)}
    \constcornerup {(#1-mux02out|-#1-msffreclkheight) ++(1,0)}
    \constcornerright {(#1-msff03-reclk)}
    -- (#1-msff03-reclk)
    %%
    %% Drawing in0 to all muxs
    %%
    (#1-msffreclkheight) ++(0,0.5)
    coordinate (#1-msffreclktomuxheight)
    %%
    (#1-mux00-in0) ++(-0.75,0)
    coordinate (#1-mux00in0right)
    coordinate (#1-tmp)
    (#1-tmp|-#1-msffreclktomuxheight)
    ...
    %%
    (#1-msff00-reclk)
    -- (#1-msffreclktomuxheight)
    \constcornerright {(#1-tmp|-#1-msffreclktomuxheight) ++(0,-1)}
    %%
    ...
    %%
    (#1-msff00-feclk|-#1-msffreclktomuxheight)
    ++(0,0.5)
    coordinate (#1-msfffeclkheight)
    %%
    (#1-msff01-feclk|-#1-msfffeclkheight)
    -- (#1-msff01-feclk)
    %%
    (#1-msff02-feclk|-#1-msfffeclkheight)
    -- (#1-msff02-feclk)
    %%
    %% last one
    %%
    (#1-msff00-feclk) -- (#1-msfffeclkheight)
    ...
    coordinate (#1-tmp)
    %%
    (#1-msff00-reclk|-#1-msffreclktomuxheight)
...
\newcommand\counterFour[6] {
    \subctkcounterFour{#1} {#2}
    (#1-msff00.center) node[]{#3}
    (#1-msff01.center) node[]{#4}
    (#1-msff02.center) node[]{#5}
    (#1-msff03.center) node[]{#6}
}

\newcommand\labelcounterFour[7] {
