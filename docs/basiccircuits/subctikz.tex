...
\ctikzsubcircuitdef{subctkgLvlDFlipFlopTST} {
    north, south, east, west,
    northeast, northwest, southeast, southwest,
    center,
    d, clk, q, qbar,
...
\ctikzsubcircuitactivate{subctkgLvlDFlipFlopTST}

\newcommand\gLvlDFlipFlopTST[2] {
    \subctkgLvlDFlipFlopTST{#1} {#2}
}
...
\ctikzsubcircuitdef{subctkgLvlAndGate} {
    north, south, east, west,
    northeast, northwest, southeast, southwest,
    center,
    ain, bin, yout,
    ...
    \gLvlNotGateRight {#1-nota} {center}
    %%
    ($(#1-l1vrt|-#1-south)!0.30!(#1-l1vrt)$)
    \gLvlNotGateRight {#1-notb} {center}
    %%
    %% Drawing layer 2
    %%
    (#1-l2vrt)
...
\ctikzsubcircuitactivate{subctkgLvlAndGate}

\newcommand\gLvlAndGate[2] {
    \subctkgLvlAndGate{#1} {#2}
}

\ctikzsubcircuitdef{subctkgLvlNandGate} {
    north, south, east, west,
    northeast, northwest, southeast, southwest,
    center,
    ain, bin, yout,
    ...
    %%
    (#1-l3vrt)
    \gLvlNotGateRight {#1-notout} {center}
    %%
    %% Connecting l1 and l2
    %%
...
\ctikzsubcircuitactivate{subctkgLvlNandGate}

\newcommand\gLvlNandGate[2] {
    \subctkgLvlNandGate{#1} {#2}
}

\ctikzsubcircuitdef{subctkgLvlNorGate} {
    north, south, east, west,
    northeast, northwest, southeast, southwest,
    center,
    ain, bin, yout,
...
\ctikzsubcircuitactivate{subctkgLvlNorGate}

\newcommand\gLvlNorGate[2] {
    \subctkgLvlNorGate{#1} {#2}
}

\ctikzsubcircuitdef{subctkgLvlOrGate} {
    north, south, east, west,
    northeast, northwest, southeast, southwest,
    center,
    ain, bin, yout,
...
\ctikzsubcircuitactivate{subctkgLvlOrGate}

\newcommand\gLvlOrGate[2] {
    \subctkgLvlOrGate{#1} {#2}
}

\ctikzsubcircuitdef{subctkgLvlNotGate} {
    north, south, east, west,
    northeast, northwest, southeast, southwest,
    center,
    ain, yout,
...
\ctikzsubcircuitactivate{subctkgLvlNotGate}

\newcommand\gLvlNotGate[2] {
    \subctkgLvlNotGate{#1} {#2}
}
