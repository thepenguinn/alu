...
\newcommand\testing[1] {
    \gLvlMSFlipFlop {#1-msff15} {d} {}
    %%
    (#1-msff15-qbar)
    ++(1.5,-1)
    %%
    \gLvlMSFlipFlop {#1-msff14} {d} {}
    (#1-msff14-qbar) ++($(#1-msff14-d)-(#1-msff15-qbar)$)
    \gLvlMSFlipFlop {#1-msff13} {d} {}
    (#1-msff13-qbar) ++($(#1-msff14-d)-(#1-msff15-qbar)$)
    \gLvlMSFlipFlop {#1-msff12} {d} {}
    %%
    %%
    %%
    (#1-msff15-qbar)
...
\begin{figure} [!ht]
    ...
    \resizebox{\textwidth}{!} {
        \begin{tikzpicture} [american]
            ...
            \testing {billie}
            %% \gLvlMSFlipFlop {billie} {reclk}
            %% \gLvlDFlipFlopSR {billie} {clk}
