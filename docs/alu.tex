...
\ctikzsubcircuitdef{subctkmuxEight} {
    ...
    \markcoordinate {#1}   {sl0} {bpin 2}
    \markcoordinate {#1}   {sl1} {bpin 3}
    \markcoordinate {#1}   {sl2} {bpin 4}%
...
\begin{circuitikz}[american]
    ...
    \aroundcornertilldownright {(0.75,0)} {(flad-pB)} {(flad-Cin)} {(1,0)}
    -- (flad-Cin)
    ...
    (msff-Rst)
    \constcornerdown {++(1,-0.5)}
    coordinate (msffRstheight)
    -- ++(1,0)

    ++(-1,-2.50)

    \muxEight{muxate}{and01} {\texttt{MUX}}

    (muxate.lpin 2) ++(-1.75,0)
    coordinate (muxvrt)

    % TOP

    (flad-Sum) -- (flad-pSum)
    \varcornerrightdown {(muxvrt|-muxate.lpin 2) ++(-0.75,0)}
    coordinate (okthis)
    -- (muxate.lpin 2)

    (xorgate-Oout) -- (xorgate-pOout)
    \undercornertillrightdown
    {($(muxate.lpin 1)-(muxate.lpin 3)$)} {(okthis)}
    {(muxvrt|-muxate.lpin 4)} {(1,0)}
    coordinate (xorgatelastbend)
    -- (muxate.lpin 4)

    (andgate-Oout) % -- (andgate-pOout)
    \undercornertillrightdown
    {($(muxate.lpin 1)-(muxate.lpin 2)$)} {(xorgatelastbend)}
    {(muxate.lpin 5)} {(1,0)}
    -- (muxate.lpin 5)
    ...
    \varcornerrightdown {(muxvrt|-muxate.lpin 6)}
    coordinate (norgatelastbend)
    -- (muxate.lpin 6)

    (orgate-Oout) -- (orgate-pOout)
    \undercornertillrightdown
    {($(muxate.lpin 1)-(muxate.lpin 2)$)} {(norgatelastbend)}
    {(muxate.lpin 7)} {(1,0)}
    -- (muxate.lpin 7)

    (nandgate-Oout) -- (nandgate-pOout)
    \varcornerrightup {(muxvrt|-muxate.lpin 9)}
    coordinate (nandgatelastbend)
    -- (muxate.lpin 9)

    (norgate-Oout) -- (norgate-pOout)
    \undercornertillrightup
    {($(muxate.lpin 1)-(muxate.lpin 2)$)} {(nandgatelastbend)}
    {(muxate.lpin 8)} {(1,0)}
    -- (muxate.lpin 8)
